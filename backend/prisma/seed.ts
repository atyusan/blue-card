...
async function seedStaffMembers() {
  ...
  const labSarah = await prisma.user.findUnique({
    where: { email: 'lab.sarah@hospital.com' },
  });
  const labJames = await prisma.user.findUnique({
    where: { email: 'lab.james@hospital.com' },
  });
...
async function seedPermissions() {
  ...
  const permissions = [
    ...
    {
      name: 'request_lab_tests',
      displayName: 'Request Lab Tests',
      description: 'Request laboratory tests for treatments',
      category: 'Laboratory Services',
      module: 'Laboratory',
    },
    {
      name: 'view_lab_requests',
      displayName: 'View Lab Requests',
      description: 'View laboratory test requests',
      category: 'Laboratory Services',
      module: 'Laboratory',
    },
    {
      name: 'claim_lab_requests',
      displayName: 'Claim Lab Requests',
      description: 'Claim lab requests from the pool',
      category: 'Laboratory Services',
      module: 'Laboratory',
    },
    {
      name: 'process_lab_tests',
      displayName: 'Process Lab Tests',
      description: 'Perform and process laboratory tests',
      category: 'Laboratory Services',
      module: 'Laboratory',
    },
    {
      name: 'submit_lab_results',
      displayName: 'Submit Lab Results',
    ...
    {
      name: 'view_lab_tests',
      displayName: 'View Lab Tests',
      description: 'View individual laboratory tests',
      category: 'Laboratory Services',
      module: 'Laboratory',
    },
    {
      name: 'create_lab_tests',
      displayName: 'Create Lab Tests',
      description: 'Create new lab tests',
      category: 'Laboratory Services',
      module: 'Laboratory',
    },
    {
      name: 'update_lab_tests',
      displayName: 'Update Lab Tests',
      description: 'Update lab test information',
      category: 'Laboratory Services',
      module: 'Laboratory',
    },
    {
      name: 'view_lab_reports',
      displayName: 'View Lab Reports',
      description: 'View laboratory reports',
      category: 'Laboratory Services',
      module: 'Laboratory',
    },
    {
      name: 'create_lab_reports',
      displayName: 'Create Lab Reports',
...
async function seedStaffRoleAssignments() {
  ...
  const assignments = [
    ...
    {
      userEmail: 'lab.sarah@hospital.com',
      roleCode: 'LAB_TECH',
    },
    {
      userEmail: 'lab.james@hospital.com',
      roleCode: 'LAB_TECH',
    },
  ];
...
async function seedServices() {
  ...
  const services = [
    ...
    {
      name: 'Stool Analysis',
      description: 'Stool examination and culture',
      categoryId: labCategory!.id,
      departmentId: departmentMap.get('Laboratory'),
      basePrice: 25.0,
      currentPrice: 25.0,
    ...
    {
      name: 'Blood Culture',
      description: 'Bacterial blood culture test',
      categoryId: labCategory!.id,
      departmentId: departmentMap.get('Laboratory'),
      basePrice: 50.0,
      currentPrice: 50.0,
    ...
    },
    {
      ...
      description: 'Hepatitis A, B, C screening',
      categoryId: labCategory!.id,
      departmentId: departmentMap.get('Laboratory'),
      basePrice: 55.0,
      currentPrice: 55.0,
    ...
    },
    {
      ...
      description: 'Sodium, potassium, chloride test',
      categoryId: labCategory!.id,
      departmentId: departmentMap.get('Laboratory'),
      basePrice: 28.0,
      currentPrice: 28.0,
    ...
    {
      name: 'Malaria Test',
      description: 'Malaria parasite screening',
      categoryId: labCategory!.id,
      departmentId: departmentMap.get('Laboratory'),
      basePrice: 15.0,
      currentPrice: 15.0,
